...
export default function Header() {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 w-full mobile-first-container ${
            scrolled
            ...
            <div
                className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out bg-black border-b border-white/[0.08] ${
                        ...
                        return (
                            <div key={item.label} className="w-full flex flex-col">
                                <div className="flex items-center justify-between">
                                    <Link
                                        href={item.href}
                                        className={`flex-1 block px-3 py-2.5 rounded-lg text-[14px] font-medium transition-all ${
